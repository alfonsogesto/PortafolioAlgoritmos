...
public class THashComparaciones implements IHash {
    ...
    public THashComparaciones(int capacidadInicial) {
        ...
        Arrays.fill(tabla, -1);  // -1 indica un espacio vacio
        size = 0;
    ...
    public int buscar(int unaClave) {
        ...
        while (tabla[indice] != -1) {
            ...
            indice = (indice + 1) % tabla.length;  // Siguiente indice
        }
        comparacionesBusquedaSinExito += comparaciones + 1; // +1 para contar la comparacion con -1
