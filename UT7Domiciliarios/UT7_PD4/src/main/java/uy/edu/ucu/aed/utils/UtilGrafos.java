...
import uy.edu.ucu.aed.tdas.IGrafoDirigido;
    ...
    public static Double[][] obtenerMatrizCostos(Map<Comparable, IVertice> vertices) {
        ...
        while (i < cantidadVertices) {
            ...
            while (j < cantidadVertices) {
                TVertice elemVerticeI = (TVertice) vertices.get(VerticesIArr[i]);
                TVertice elemVerticeJ = (TVertice) vertices.get(VerticesJArr[j]);
