...
public abstract class TGrafoDirigido implements IGrafoDirigido {

    protected Map<Comparable, IVertice> vertices; // lista de vertices del grafo.-

    public TGrafoDirigido(Collection<IVertice> vertices, Collection<TArista> aristas) {
    ...
    public Collection<TVertice> bpf(TVertice vertice) {
        ...
        if (this.existeVertice(vertice.getEtiqueta())) {
            IVertice vert = this.buscarVertice(vertice.getEtiqueta());
            vert.bpf(visitados);
        }
        return visitados;
    }
    ...
    public Collection<TVertice> bpf(Comparable etiquetaOrigen) {
        ...
        if (this.existeVertice(etiquetaOrigen)) {
            IVertice vertice = this.buscarVertice(etiquetaOrigen);
    ...
    public Comparable centroDelGrafo() {
        Iterator<IVertice> it = vertices.values().iterator();
    ...
    public TCaminos todosLosCaminos(Comparable etiquetaOrigen, Comparable etiquetaDestino) {
        ...
        IVertice u = buscarVertice(etiquetaDestino);
        if ((v != null) && (u != null)) {
            TCaminos todosLosCaminos = new TCaminos();
            TCamino caminoPrevio = new TCamino((TVertice) v);
    ...
    public Collection<TVertice> bea() {
        if (this.getVertices().isEmpty()) {
            ...
            this.desvisitarVertices();
            for (IVertice vertV : this.getVertices().values()) {
                if (!vertV.getVisitado()) {
                    Collection<TVertice> verts = new LinkedList<TVertice>();
                    ((TVertice) vertV).bea(verts);
                    return verts;
                }
            }
        }
